package basic.enumDemo.postOffice;//: enumerated/PostOffice.java
 ...
 *  <h4>职责链模式</h4>
 *  <br>
 *  用户以多种不同的方式来解决一个问题，然后将他们链接在一起。</br><br>一个请求过来的时候,遍历这个链,
 *  直到链中某个方法能够处理这个请求。
 *  </br>
 *  <br>
 *   邮局模型为例：<br/>
 *   邮局需要尽可能通用的方法来处理每一封邮件，并且要不断尝试处理邮件，直到该邮件最终被确定为一封死信
 *  </br>
 *
 */
class Mail {
